...
def read_data(file_path):
    data = pd.read_csv(
        ...
        names=[
            ...
            "bottom_h5_index",
            "bottom_subject",
            "bottom_avg_cited_journal_hindex",
            "random_orcid",
            "random_h5_index",
            "random_subject",
            "random_avg_cited_journal_hindex",
        ],
    )
    return data
...
def process_data(data):
    bottom_avg_hindex = data[
        "bottom_avg_cited_journal_hindex"
    ].dropna()  # 4th column
    random_avg_hindex = data[
        "random_avg_cited_journal_hindex"
    ].dropna()  # 8th column
...
def main(file_path):
    ...
    # Write all results to a file (reports/avg_h5_mw.txt)

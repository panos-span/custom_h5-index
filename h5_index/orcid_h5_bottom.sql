...
CREATE INDEX IF NOT EXISTS rolap.bottom_filtered_works_orcid_doi_idx 
    ON bottom_filtered_works_orcid (doi);
-- Index on ORCID for efficient grouping and filtering in h5-index calculations
CREATE INDEX IF NOT EXISTS rolap.bottom_filtered_works_orcid_orcid_idx 
    ON bottom_filtered_works_orcid (orcid);
...
SELECT h5_index_per_subject.orcid AS orcid, h5_index_per_subject.subject, 

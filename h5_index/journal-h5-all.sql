...
CREATE INDEX IF NOT EXISTS rolap.issn_h5_h5_index_idx ON issn_subject_h5 (
    h5_index
);
...
SELECT
    title,
    h5_index
FROM rolap.issn_subject_h5 LEFT JOIN journal_names
    ON
        rolap.issn_subject_h5.issn = journal_names.issn_print

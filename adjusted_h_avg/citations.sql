...
CREATE TABLE rolap.citations AS
  SELECT cited_work.issn, cited_work.subject, COUNT(*) AS citations_number
  ...
  WHERE citing_work.published_year = 2022
    AND cited_work.published_year BETWEEN 2020 AND 2021
